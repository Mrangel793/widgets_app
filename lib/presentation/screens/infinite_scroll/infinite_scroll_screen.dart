...
class _InifiniteScrollScreenState extends State<InifiniteScrollScreen> {
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      //determinar si estoy al final o cerca del final del scroll
      //scrollController.position.pixels es la posicion actual del scroll
      //scrollController.position.maxScrollExtent la posicion maxima del scroll
  ...
  void addFiveImages() {
    //tomar el ultimo id de la lista
    final lastId = imagesIds.last;
    //barrer esos elementos e insertar 5 mas
